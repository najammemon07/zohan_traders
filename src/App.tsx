...
function AppLinkButton({ href, children, className, size = 'md' }: { href: string; children: React.ReactNode; className: string; size?: 'sm' | 'md' | 'lg' }) {
  return (
      ...
      <Box as="header" position="sticky" top="0" zIndex="20" bg="rgba(8,8,8,.88)" backdropFilter="blur(18px)" borderBottom="1px solid rgba(212,175,55,.14)">
        <Container maxW="1200px" py="16px">
          <Flex align="center" justify="space-between">
            ...
            <HStack gap="3">
              <Box display={{ base: 'none', sm: 'block' }}>
                <AppLinkButton href="#contact" className="gold-button" size="sm">Get in Touch</AppLinkButton>
              </Box>
          ...
          <SimpleGrid columns={{ base: 1, lg: 2 }} gap={{ base: '12', lg: '20' }} alignItems="center">
            <VStack align="start" gap="6">
              ...
              <Heading className="hero-title" fontSize={{ base: '48px', sm: '62px', md: '78px' }} lineHeight=".98">
                Pure Taste.<br /><Box as="span" className="gold-text">Trusted Quality.</Box>
              </Heading>
              ...
              <HStack gap="4" pt="2" flexWrap="wrap">
                <AppLinkButton href="#products" className="gold-button" size="lg">Explore Products</AppLinkButton>
                <AppLinkButton href="#about" className="dark-button" size="lg">Our Story</AppLinkButton>
              </HStack>
            ...
            <Box className="hero-badge" display={{ base: 'none', lg: 'block' }}>
              <Box className="hero-circle">
                <Text className="circle-small">ZT</Text><Text className="circle-title">ZAIQO</Text>
                <Text className="circle-subtitle">REFINED IODIZED SALT</Text><Box className="circle-divider" />
      ...
      <Box className="trust-strip">
        <Container maxW="1200px" py="6">
          <SimpleGrid columns={{ base: 2, md: 4 }} gap="5">
            {[['01', 'Refined Quality'], ['02', 'Iodized Salt'], ['03', 'Clean Packaging'], ['04', 'Trusted Brand']].map(([number, title]) => (
        ...
        <Container maxW="1200px" py={{ base: '80px', md: '110px' }}>
          <SimpleGrid columns={{ base: 1, md: 2 }} gap={{ base: '10', md: '20' }} alignItems="center">
            <VStack align="start" gap="5">
              ...
              <Text color="#a7a7a7" lineHeight="1.9" maxW="570px">Zohan Traders is focused on delivering dependable refined iodized salt with a clean, premium presentation. Our ZT ZAIQO range is designed around consistency, quality and value.</Text>
              <AppLinkButton href="#contact" className="dark-button">Talk to Zohan Traders</AppLinkButton>
            </VStack>
            <Box className="about-card">
              <Text className="about-card-label">ZT ZAIQO</Text><Heading fontSize="32px" mt="3">Refined Iodized Salt</Heading>
              <Text color="#999" mt="4" lineHeight="1.8">A modern salt brand built for households, retailers and growing distribution.</Text>
              <Box className="gold-rule" /><Text color="#d4af37" fontSize="12px" letterSpacing="3px">ZOHAN TRADERS</Text>
            </Box>
          </SimpleGrid>
        </Container>
      </Box>
      ...
      <Box id="products">
        <Container maxW="1200px" py={{ base: '80px', md: '110px' }}>
          <Flex justify="space-between" align={{ base: 'start', md: 'end' }} gap="6" mb="10" direction={{ base: 'column', md: 'row' }}>
            <VStack align="start" gap="3"><Text className="section-kicker">OUR PRODUCTS</Text><Heading fontSize={{ base: '34px', md: '48px' }}>ZT ZAIQO Range</Heading></VStack>
          ...
          <SimpleGrid columns={{ base: 1, md: 3 }} gap="6">
            {products.map((product) => (
              <Box className="product-card" key={product.size}>
                <Flex justify="space-between" align="start"><Text className="product-size">{product.size}</Text><Text className="product-tag">{product.tag}</Text></Flex>
                <Heading size="md" mt="8">ZT ZAIQO</Heading><Text color="#d4af37" fontSize="13px" mt="2">REFINED IODIZED SALT</Text>
        ...
        <Container maxW="1200px" py={{ base: '75px', md: '95px' }}>
          <SimpleGrid columns={{ base: 1, md: 2 }} gap="10" alignItems="center">
            ...
            <Box className="contact-card">
              <Text color="#888" fontSize="12px" letterSpacing="2px">ZOHAN TRADERS</Text><Text fontSize="20px" fontWeight="700" mt="3">Refined Salt Business</Text>
              <Text color="#999" mt="3">Site Area, Karachi, Pakistan</Text><Box className="gold-rule" />
              <Text color="#d4af37" fontWeight="700">0313 3976670</Text><Text color="#d4af37" fontWeight="700" mt="1">0309 7431271</Text>
              <Box mt="6" w="full"><AppLinkButton href="tel:+923133976670" className="gold-button">Call Us</AppLinkButton></Box>
            </Box>
          </SimpleGrid>
        </Container>
      </Box>
